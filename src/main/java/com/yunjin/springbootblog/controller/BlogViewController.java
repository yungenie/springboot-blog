...
public class BlogViewController {
     ...
     * 블로그 글 상세보기 뷰
     * @param id 글 ID
     * @return 블로그 글 ID에 해당하는 내용을 담은 뷰 반환
     */
     ...
     * 블로그 글 수정하기 뷰
     * @param id 글 ID
     * @return 블로그 글 ID에 해당하는 수정 대상 내용을 담은 뷰 반환
     */
    @GetMapping("/articles/edit/{id}")
    public String newArticle(@PathVariable Long id, Model model) {
        Article article = blogService.findById(id);
        model.addAttribute("article", new ArticleViewResponseDto(article));
